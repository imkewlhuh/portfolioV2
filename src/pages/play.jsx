import {
    Container, Paper, List, ListItem,
    ListItemAvatar, Card, CardContent,
    Divider, Grow, Fade
} from "@mui/material";
                        ...
                        <List sx={{ minHeight: "50%" }} >
                            <Fade in={true} timeout={800} style={{ transitionDelay: 4000 }} >
                                <ListItem alignItems="flex-start" >
                                    ...
                                    Explore the sections to progress the Battle Pass!
                                </ListItem>
                            </Fade>
                            <br />
                            ...
                            <Fade in={true} timeout={800} style={{ transitionDelay: 4600 }} >
                                <ListItem alignItems="flex-start" >
                                    ...
                                    Earn XP by viewing each item on a page to clear it. Clear all pages to complete the Battle Pass.
                                </ListItem>
                            </Fade>
                        </List>
                    </CardContent>
